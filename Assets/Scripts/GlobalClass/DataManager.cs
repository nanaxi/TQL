...
public static class DataManager
{
    ...
    public struct MJCardStruct
    {
        ...
        public MJCardStruct(CardsType CT, int value, uint CardID)
        {
            this.CT = CT;
            this.Value = value;
    ...
    public static MJCardStruct ToCard(this uint cardID)
    {
        MJCardStruct cardStruct;
        ...
        cardStruct = new MJCardStruct(CT, (int)value, cardID);
        return cardStruct;
